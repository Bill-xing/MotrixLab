...
class AnymalCEnv(NpEnv):
    ...
    def _init_termination_contact(self):
        ...
        for base_name in cfg.asset.terminate_after_contacts_on:
            try:
                ...
                if base_idx is not None:
                    ...
                    warnings.warn(f"Geom '{base_name}' not found in model", RuntimeWarning, stacklevel=2)
            except Exception as e:
                warnings.warn(f"Error finding base geom '{base_name}': {e}", RuntimeWarning, stacklevel=2)
        ...
        if base_indices:
            ...
            warnings.warn("No base contacts configured for termination", RuntimeWarning, stacklevel=2)
    ...
    def _init_foot_contact(self):
        ...
        for foot_name in cfg.asset.foot_names:
            try:
                ...
                if foot_idx is not None:
                    ...
                    warnings.warn(f"Foot geom '{foot_name}' not found in model", RuntimeWarning, stacklevel=2)
            except Exception as e:
                warnings.warn(f"Error finding foot geom '{foot_name}': {e}", RuntimeWarning, stacklevel=2)
        ...
        if foot_indices:
            ...
            warnings.warn("No foot contacts configured", RuntimeWarning, stacklevel=2)
